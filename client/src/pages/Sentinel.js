...
const Sentinel = () => {
  ...
  const triggerPanic = () => {
    stopListening();
    navigate('/dashboard', { state: { autoSOS: true } });
  };
    ...
    <div style={styles.page}>
      <div style={styles.card}>
        ...
        <header style={styles.header}>
          <h1 style={styles.title}>Sentinel</h1>
          <span style={{
            ...styles.badge,
            background: model ? '#e6f4ea' : '#fff4e5',
            color: model ? '#137333' : '#b26a00'
          }}>
        ...
        {!listening ? (
          ...
          <button onClick={stopListening} style={styles.dangerBtn}>
            Stop Listening
          </button>
        )}

        <p style={styles.helper}>
          Say <b>“STOP”</b> loudly to trigger SOS
        </p>
